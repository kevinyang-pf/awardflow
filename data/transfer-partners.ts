...
export const airlinePartners: TransferPartner[] = [
  { id: "aegean", name: "Aegean Airlines Miles+Bonus", shortName: "Aegean", type: "airline", alliance: "star-alliance", country: "Greece" },
  { id: "aer-lingus", name: "Aer Lingus AerClub", shortName: "Aer Lingus", type: "airline", alliance: "none", country: "Ireland" },
  { id: "aeromexico", name: "Aeromexico Rewards", shortName: "Aeromexico", type: "airline", alliance: "skyteam", country: "Mexico" },
  { id: "air-canada", name: "Air Canada Aeroplan", shortName: "Air Canada", type: "airline", alliance: "star-alliance", country: "Canada" },
  { id: "air-france-klm", name: "Air France-KLM Flying Blue", shortName: "Flying Blue", type: "airline", alliance: "skyteam", country: "France" },
  { id: "air-new-zealand", name: "Air New Zealand Airpoints", shortName: "Air NZ", type: "airline", alliance: "star-alliance", country: "New Zealand" },
  { id: "alaska", name: "Alaska Airlines Mileage Plan", shortName: "Alaska", type: "airline", alliance: "oneworld", country: "USA" },
  { id: "alaska-atmos", name: "Alaska Airlines Atmos Rewards", shortName: "Alaska Atmos", type: "airline", alliance: "oneworld", country: "USA" },
  { id: "american", name: "American Airlines AAdvantage", shortName: "American", type: "airline", alliance: "oneworld", country: "USA" },
  { id: "ana", name: "ANA Mileage Club", shortName: "ANA", type: "airline", alliance: "star-alliance", country: "Japan" },
  { id: "asiana", name: "Asiana Airlines", shortName: "Asiana", type: "airline", alliance: "star-alliance", country: "South Korea" },
  { id: "avianca", name: "Avianca LifeMiles", shortName: "Avianca", type: "airline", alliance: "star-alliance", country: "Colombia" },
  { id: "british-airways", name: "British Airways Executive Club", shortName: "British Airways", type: "airline", alliance: "oneworld", country: "UK" },
  { id: "cathay", name: "Cathay Pacific Asia Miles", shortName: "Cathay", type: "airline", alliance: "oneworld", country: "Hong Kong" },
  { id: "copa", name: "Copa Airlines ConnectMiles", shortName: "Copa", type: "airline", alliance: "star-alliance", country: "Panama" },
  { id: "delta", name: "Delta SkyMiles", shortName: "Delta", type: "airline", alliance: "skyteam", country: "USA" },
  { id: "emirates", name: "Emirates Skywards", shortName: "Emirates", type: "airline", alliance: "none", country: "UAE" },
  { id: "etihad", name: "Etihad Guest", shortName: "Etihad", type: "airline", alliance: "none", country: "UAE" },
  { id: "eva", name: "EVA Air Infinity MileageLands", shortName: "EVA Air", type: "airline", alliance: "star-alliance", country: "Taiwan" },
  { id: "finnair", name: "Finnair Plus", shortName: "Finnair", type: "airline", alliance: "oneworld", country: "Finland" },
  { id: "frontier", name: "FRONTIER Miles", shortName: "Frontier", type: "airline", alliance: "none", country: "USA" },
  { id: "hainan", name: "Hainan Airlines Fortune Wings", shortName: "Hainan", type: "airline", alliance: "none", country: "China" },
  { id: "hawaiian", name: "Hawaiian Airlines HawaiianMiles", shortName: "Hawaiian", type: "airline", alliance: "none", country: "USA" },
  { id: "iberia", name: "Iberia Plus", shortName: "Iberia", type: "airline", alliance: "oneworld", country: "Spain" },
  { id: "jal", name: "Japan Airlines Mileage Bank", shortName: "JAL", type: "airline", alliance: "oneworld", country: "Japan" },
  { id: "jetblue", name: "JetBlue TrueBlue", shortName: "JetBlue", type: "airline", alliance: "none", country: "USA" },
  { id: "latam", name: "LATAM Pass", shortName: "LATAM", type: "airline", alliance: "none", country: "Chile" },
  { id: "qantas", name: "Qantas Frequent Flyer", shortName: "Qantas", type: "airline", alliance: "oneworld", country: "Australia" },
  { id: "qatar", name: "Qatar Airways Privilege Club", shortName: "Qatar", type: "airline", alliance: "oneworld", country: "Qatar" },
  { id: "saudia", name: "Saudia Alfursan", shortName: "Saudia", type: "airline", alliance: "skyteam", country: "Saudi Arabia" },
  { id: "singapore", name: "Singapore Airlines KrisFlyer", shortName: "Singapore", type: "airline", alliance: "star-alliance", country: "Singapore" },
  { id: "southwest", name: "Southwest Rapid Rewards", shortName: "Southwest", type: "airline", alliance: "none", country: "USA" },
  { id: "spirit", name: "Spirit Airlines Free Spirit", shortName: "Spirit", type: "airline", alliance: "none", country: "USA" },
  { id: "tap", name: "TAP Air Portugal Miles&Go", shortName: "TAP", type: "airline", alliance: "star-alliance", country: "Portugal" },
  { id: "thai", name: "Thai Airways Royal Orchid Plus", shortName: "Thai", type: "airline", alliance: "star-alliance", country: "Thailand" },
  { id: "turkish", name: "Turkish Airlines Miles&Smiles", shortName: "Turkish", type: "airline", alliance: "star-alliance", country: "Turkey" },
  { id: "united", name: "United MileagePlus", shortName: "United", type: "airline", alliance: "star-alliance", country: "USA" },
  { id: "virgin-atlantic", name: "Virgin Atlantic Flying Club", shortName: "Virgin Atlantic", type: "airline", alliance: "none", country: "UK" },
  { id: "virgin-australia", name: "Virgin Australia Velocity", shortName: "Virgin Australia", type: "airline", alliance: "none", country: "Australia" },
  { id: "virgin-red", name: "Virgin Red", shortName: "Virgin Red", type: "airline", alliance: "none", country: "UK" },
  { id: "vueling", name: "Vueling Club", shortName: "Vueling", type: "airline", alliance: "none", country: "Spain" },
];
