...
// Transfer Partners - Airlines (using program names as shortName)
export const airlinePartners: TransferPartner[] = [
  { id: "aegean", name: "Aegean Airlines Miles+Bonus", shortName: "Miles+Bonus", type: "airline", alliance: "star-alliance", country: "Greece", logoUrl: "/logos/airlines/aegean.svg" },
  { id: "aer-lingus", name: "Aer Lingus AerClub", shortName: "AerClub", type: "airline", alliance: "none", country: "Ireland", logoUrl: "/logos/airlines/aer-lingus.svg" },
  { id: "aeromexico", name: "Aeromexico Rewards", shortName: "Aeromexico Rewards", type: "airline", alliance: "skyteam", country: "Mexico", logoUrl: "/logos/airlines/aeromexico.svg" },
  { id: "air-canada", name: "Air Canada Aeroplan", shortName: "Aeroplan", type: "airline", alliance: "star-alliance", country: "Canada", logoUrl: "/logos/airlines/air-canada.svg" },
  ...
  { id: "air-new-zealand", name: "Air New Zealand Airpoints", shortName: "Airpoints", type: "airline", alliance: "star-alliance", country: "New Zealand", logoUrl: "/logos/airlines/air-new-zealand.svg" },
  { id: "alaska", name: "Alaska Airlines Mileage Plan", shortName: "Mileage Plan", type: "airline", alliance: "oneworld", country: "USA", logoUrl: "/logos/airlines/alaska.svg" },
  { id: "alaska-atmos", name: "Alaska Airlines Atmos Rewards", shortName: "Atmos", type: "airline", alliance: "oneworld", country: "USA", logoUrl: "/logos/airlines/alaska-atmos.svg" },
  { id: "american", name: "American Airlines AAdvantage", shortName: "AAdvantage", type: "airline", alliance: "oneworld", country: "USA", logoUrl: "/logos/airlines/american.svg" },
  { id: "ana", name: "ANA Mileage Club", shortName: "Mileage Club", type: "airline", alliance: "star-alliance", country: "Japan", logoUrl: "/logos/airlines/ana.svg" },
  { id: "asiana", name: "Asiana Airlines Club", shortName: "Asiana Club", type: "airline", alliance: "star-alliance", country: "South Korea", logoUrl: "/logos/airlines/asiana.svg" },
  { id: "avianca", name: "Avianca LifeMiles", shortName: "LifeMiles", type: "airline", alliance: "star-alliance", country: "Colombia", logoUrl: "/logos/airlines/avianca.svg" },
  { id: "british-airways", name: "British Airways Executive Club", shortName: "Avios", type: "airline", alliance: "oneworld", country: "UK", logoUrl: "/logos/airlines/british-airways.svg" },
  { id: "cathay", name: "Cathay Pacific Asia Miles", shortName: "Asia Miles", type: "airline", alliance: "oneworld", country: "Hong Kong", logoUrl: "/logos/airlines/cathay.svg" },
  { id: "copa", name: "Copa Airlines ConnectMiles", shortName: "ConnectMiles", type: "airline", alliance: "star-alliance", country: "Panama", logoUrl: "/logos/airlines/copa.svg" },
  { id: "delta", name: "Delta SkyMiles", shortName: "SkyMiles", type: "airline", alliance: "skyteam", country: "USA", logoUrl: "/logos/airlines/delta.svg" },
  { id: "emirates", name: "Emirates Skywards", shortName: "Skywards", type: "airline", alliance: "none", country: "UAE", logoUrl: "/logos/airlines/emirates.svg" },
  { id: "etihad", name: "Etihad Guest", shortName: "Etihad Guest", type: "airline", alliance: "none", country: "UAE", logoUrl: "/logos/airlines/etihad.svg" },
  { id: "eva", name: "EVA Air Infinity MileageLands", shortName: "Infinity", type: "airline", alliance: "star-alliance", country: "Taiwan", logoUrl: "/logos/airlines/eva.svg" },
  { id: "finnair", name: "Finnair Plus", shortName: "Finnair Plus", type: "airline", alliance: "oneworld", country: "Finland", logoUrl: "/logos/airlines/finnair.svg" },
  { id: "frontier", name: "FRONTIER Miles", shortName: "FRONTIER Miles", type: "airline", alliance: "none", country: "USA", logoUrl: "/logos/airlines/frontier.svg" },
  { id: "hainan", name: "Hainan Airlines Fortune Wings", shortName: "Fortune Wings", type: "airline", alliance: "none", country: "China", logoUrl: "/logos/airlines/hainan.svg" },
  { id: "hawaiian", name: "Hawaiian Airlines HawaiianMiles", shortName: "HawaiianMiles", type: "airline", alliance: "none", country: "USA", logoUrl: "/logos/airlines/hawaiian.svg" },
  { id: "iberia", name: "Iberia Plus", shortName: "Iberia Plus", type: "airline", alliance: "oneworld", country: "Spain", logoUrl: "/logos/airlines/iberia.svg" },
  { id: "jal", name: "Japan Airlines Mileage Bank", shortName: "Mileage Bank", type: "airline", alliance: "oneworld", country: "Japan", logoUrl: "/logos/airlines/jal.svg" },
  { id: "jetblue", name: "JetBlue TrueBlue", shortName: "TrueBlue", type: "airline", alliance: "none", country: "USA", logoUrl: "/logos/airlines/jetblue.svg" },
  { id: "latam", name: "LATAM Pass", shortName: "LATAM Pass", type: "airline", alliance: "none", country: "Chile", logoUrl: "/logos/airlines/latam.svg" },
  { id: "qantas", name: "Qantas Frequent Flyer", shortName: "Frequent Flyer", type: "airline", alliance: "oneworld", country: "Australia", logoUrl: "/logos/airlines/qantas.svg" },
  { id: "qatar", name: "Qatar Airways Privilege Club", shortName: "Privilege Club", type: "airline", alliance: "oneworld", country: "Qatar", logoUrl: "/logos/airlines/qatar.svg" },
  { id: "saudia", name: "Saudia Alfursan", shortName: "Alfursan", type: "airline", alliance: "skyteam", country: "Saudi Arabia", logoUrl: "/logos/airlines/saudia.svg" },
  { id: "singapore", name: "Singapore Airlines KrisFlyer", shortName: "KrisFlyer", type: "airline", alliance: "star-alliance", country: "Singapore", logoUrl: "/logos/airlines/singapore.svg" },
  { id: "southwest", name: "Southwest Rapid Rewards", shortName: "Rapid Rewards", type: "airline", alliance: "none", country: "USA", logoUrl: "/logos/airlines/southwest.svg" },
  { id: "spirit", name: "Spirit Airlines Free Spirit", shortName: "Free Spirit", type: "airline", alliance: "none", country: "USA", logoUrl: "/logos/airlines/spirit.svg" },
  { id: "tap", name: "TAP Air Portugal Miles&Go", shortName: "Miles&Go", type: "airline", alliance: "star-alliance", country: "Portugal", logoUrl: "/logos/airlines/tap.svg" },
  { id: "thai", name: "Thai Airways Royal Orchid Plus", shortName: "Royal Orchid Plus", type: "airline", alliance: "star-alliance", country: "Thailand", logoUrl: "/logos/airlines/thai.svg" },
  { id: "turkish", name: "Turkish Airlines Miles&Smiles", shortName: "Miles&Smiles", type: "airline", alliance: "star-alliance", country: "Turkey", logoUrl: "/logos/airlines/turkish.svg" },
  { id: "united", name: "United MileagePlus", shortName: "MileagePlus", type: "airline", alliance: "star-alliance", country: "USA", logoUrl: "/logos/airlines/united.svg" },
  { id: "virgin-atlantic", name: "Virgin Atlantic Flying Club", shortName: "Flying Club", type: "airline", alliance: "skyteam", country: "UK", logoUrl: "/logos/airlines/virgin-atlantic.svg" },
  { id: "virgin-australia", name: "Virgin Australia Velocity", shortName: "Velocity", type: "airline", alliance: "none", country: "Australia", logoUrl: "/logos/airlines/virgin-australia.svg" },
  ...
  { id: "vueling", name: "Vueling Club", shortName: "Vueling Club", type: "airline", alliance: "none", country: "Spain", logoUrl: "/logos/airlines/vueling.svg" },
];
